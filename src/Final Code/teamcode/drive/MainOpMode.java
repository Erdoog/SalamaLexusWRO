        ...
        if (position == 0)
            ...
            if (quals)
            {
                ...
                else
                {
                    ...
                    Pose2d newPose = newPose2d(-50 - (150 - oldPose.getX() * 2.54), oldPose.getY(), Math.toDegrees(oldPose.getHeading()));
...
//                            .build();
            ...
            if (lastPos == 0)
            {
                newPose = new Pose2d(lastPose.getY() - 13.25 / 2.54, -lastPose.getX() - 2 / 2.54, lastPose.getHeading() - r(90));
            } else if (lastPos == 1)
            {
                newPose = new Pose2d(lastPose.getY() - 13.25 / 2.54, -lastPose.getX() - 5 / 2.54, lastPose.getHeading() - r(90));
            } else if (lastPos == 2)
            {
                newPose = new Pose2d(lastPose.getY() - 13.25 / 2.54, -lastPose.getX() - 7 / 2.54, lastPose.getHeading() - r(90));
            } else
            {
                newPose = new Pose2d(lastPose.getY() - 10 / 2.54, -lastPose.getX() - 2 / 2.54, lastPose.getHeading() - r(90));
            }
            drive1.setPoseEstimate(newPose);
            if (noneCount == 2)
                break;
    ...
    private Color getColor()
    {
        if (DetectionPipeLine.redArea > minimalAreaThreshold
         && DetectionPipeLine.greenArea > minimalAreaThreshold)
            ...
            return (DetectionPipeLine.greenArea > DetectionPipeLine.redArea ?
